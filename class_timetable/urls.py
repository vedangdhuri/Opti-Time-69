...
urlpatterns = [
    ...
    path(
        "input/<str:class_key>/delete/<int:input_id>/",
        views.delete_input,
        name="delete_input",
    ),
    path("generate-all/", views.generate_all_timetables_view, name="generate_all"),
    path("view-all/", views.view_all_timetables_view, name="view_all"),
    ...
    path(
        "validation/<str:class_key>/", views.validate_workload_view, name="validation"
    ),
